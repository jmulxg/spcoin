...
uint256 hashGenesisBlock("0x51a21772588c0f1be4f6ec51224144a391d8f510a3be4e3a6c6ecc260d9d4db1");
...
static const int64 nTargetTimespan = 10 * 30; // Spcoin: 3.5 days
static const int64 nTargetSpacing = 1 * 30; // Spcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x51a21772588c0f1be4f6ec51224144a391d8f510a3be4e3a6c6ecc260d9d4db1");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "BJ Times 01/Mar/2018 Ming Ming, ShangPin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1519833600;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2769318;
        ...
        assert(block.hashMerkleRoot == uint256("0xd3c4aaca57248830eadcda2a52149fbc5bc0932b58b22ea4dabbed22abfc03ed"));
        block.print();
